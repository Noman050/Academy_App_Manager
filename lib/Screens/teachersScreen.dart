...
class _CardListState extends State<CardList> {
  ...
  final Stream _classes = FirebaseFirestore.instance.collection('manager').doc(AuthenticationHelper().getID()).collection('teachers').snapshots();
      ...
      setState(() {
        ...
        showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content:
              const Text("Teacher Information Updated"),
            ));
        classvalue = null;
        subjectvalue = null;
      });
                        ...
                        IconButton(
                          onPressed:
                            ...
                            await showDialog(context: context, builder: (context)=> AlertDialog(
                              title: const Text('Update Teacher Details',style: TextStyle(fontSize: 20,color: Colors.deepPurple)),
                              content: Form(
                                key: _formkey,
